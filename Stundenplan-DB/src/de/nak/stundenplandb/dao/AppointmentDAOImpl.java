...
/**
 * Implementation of the Appointment-DAO
 * 
 * @author Lars Lembke, Fabian Kolossa
 *
 */
public class AppointmentDAOImpl extends GenericDAOImpl<Appointment> implements
		AppointmentDAO {
	...
	public List<Appointment> loadAppointmentsForRoom(Room room) {
		List<Appointment> appointments = sessionFactory
				.getCurrentSession()
				.createQuery(
						"SELECT a FROM Appointment a " + "JOIN a.meeting m "
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Appointment> loadAppointmentsForLecturer(Lecturer lecturer) {
		List<Appointment> appointments = sessionFactory
				.getCurrentSession()
				.createQuery(
						"SELECT a FROM Appointment a " + "JOIN a.meeting m "
	...
	public List<Appointment> loadAppointmentsForStudentGroup(
		...
		List<Appointment> appointments = sessionFactory
				...
				.setEntity("cohort", studentGroup.getCohort()).list();
		return appointments;
	}
