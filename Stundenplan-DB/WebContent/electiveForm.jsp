...
<s:form cssClass="strutsTable">
	...
	<sj:datepicker name="startDate" key="lbl.startDate"
		value="%{startDate}" timepicker="true" timepickerFormat="HH:mm"
		displayFormat="dd.mm.yy" changeMonth="true" changeYear="true"
		requiredLabel="true" showOn="button" />
	<sj:datepicker name="endDate" key="lbl.endDate" value="%{endDate}"
		timepicker="true" timepickerFormat="HH:mm" displayFormat="dd.mm.yy"
		changeMonth="true" changeYear="true" requiredLabel="true"
		showOn="button" />

	<s:select name="roomIds" key="lbl.rooms" list="allRooms" listKey="id"
		listValue="displayName" value="roomIds" multiple="true" size="5"
		requiredLabel="true" />
	<s:if test="!isShowOnlyFreeRooms()">
		<s:submit key="btn.showAvailableRooms"
			action="ShowAvailableRoomsForElective" />
	</s:if>
	<s:else>
		<s:submit key="btn.CancelShowAvailableRooms"
			action="CancelShowAvailableRoomsForElective" />
	</s:else>
