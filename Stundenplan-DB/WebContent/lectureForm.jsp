...
<s:form>
	...
	<sj:datepicker name="endDate" key="lbl.endDate"
		value="%{lecture.appointments[0].end}" timepicker="true"
		timepickerFormat="HH:mm" displayFormat="dd.mm.yy" changeMonth="true"
		changeYear="true" requiredLabel="true" />
